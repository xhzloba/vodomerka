...
function normalizeSettings(value: Partial<AppSettings>): AppSettings {
  return {
    ...
    cardAspect: normalizeCardAspect(value.cardAspect),
    collectionLayout: normalizeCollectionLayout(value.collectionLayout),
    detailPresentation: normalizeDetailPresentation(value.detailPresentation),
    ...
    setupWelcomeDismissed: value.setupWelcomeDismissed ?? DEFAULT_APP_SETTINGS.setupWelcomeDismissed,
