...
export function EpisodePickerDialog({
  ...
  return createPortal(
    <div className="episode-picker" role="presentation">
      <button
        type="button"
        className="episode-picker__backdrop"
        aria-label="Закрыть"
        onClick={onCancel}
        disabled={isOpening}
      />
      ...
      <div
        className="episode-picker__panel"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="episode-picker__header">
          <div className="episode-picker__heading">
            <h2 id="episode-picker-title" className="episode-picker__title">
              {title}
            </h2>
            <p className="episode-picker__hint">
        ...
        <div className="episode-picker__actions">
          <button
            type="button"
            className="episode-picker__btn episode-picker__btn--cancel"
            onClick={onCancel}
            disabled={isOpening}
          >
            Отмена
          ...
          <button
            type="button"
            className="episode-picker__btn episode-picker__btn--primary"
            onClick={() => {
              if (selectedPath) {
                onConfirm(selectedPath);
              }
